...
OPENMVG_SFM_BIN = "E:/SFM/openMVG/build/Windows-AMD64-/Release"

# Indicate the openMVG camera sensor width directory
CAMERA_SENSOR_WIDTH_DIRECTORY = "E:/SFM/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
...
pIntrisics = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_SfMInit_ImageListing"),  "-i", input_dir, "-o", matches_dir, "-d", camera_file_params, "-f", "8334"] )
pIntrisics.wait()
